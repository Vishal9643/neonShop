  ...
  return (
    <div>
      ...
      <div className=" py-10 bg-gray-100">
        <div className="px-5 lg:px-20">
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-3 md:flex-row justify-between  ">
              ...
              <div className="flex items-center gap-2">
                <p className="text-black">Shop by category</p>
                <select
                  className="capitalize p-1 border border-gray-300"
                  defaultValue={state.category}
                  onChange={(e) => changeCategory(e)}
        ...
        <div className="px-5 lg:px-10 grid grid-cols-1 md:grid-cols-4  gap-x-12 gap-y-8 bg-black mt-4">
    ...
    <>
      ...
      >
        ...
        <div className="product-item mt-2 py-2">
          ...
          <p className="text-white font-montserrat mb-2 text-center mt-1">
