...
export default function Home({ products }) {
  return (
    <div className="">
      ...
      {/* <script
        async
        src="https://www.googletagmanager.com/gtag/js?id=G-PBYZCF20MG"
      />
      ...
      <script
        dangerouslySetInnerHTML={{
          __html: `
              ...
              gtag('js', new Date());
              gtag('config', 'G-PBYZCF20MG', { page_path: window.location.pathname });
            `,
        }}
      /> */}
      <Script
      ...
      <section className=" pt-5  relative text-white  bg-black">
        ...
        <div className="mx-auto max-w-max py-10 flex flex-col sm:flex-row gap-10 uppercase whitespace-nowrap font-semibold ">
          <CustomLink
            href="/shop"
            text="shop"
            className="h-12 w-52 flex items-center justify-center bg-gray-900 rounded-lg hover-active"
          />
          <CustomLink
            href="/custom-neon-sign"
            text="design your neon"
            className="h-12 w-52 flex items-center justify-center bg-white text-black filter rounded-lg hover-active"
          />
        </div>
      </section>
      <section className="px-5 lg:px-10 bg-white">
      ...
      <section
        className="px-5 lg:px-20 py-10 my-10 bg-black"
        style={{
          background:
